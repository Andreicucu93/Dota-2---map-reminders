...
class TimerApp:
    def __init__(self, root):
        ...
        # Start/Edit button
        self.start_button = ctk.CTkButton(root, text="Start", width=100, height=30, command=self.toggle_timer)
        ...
        self.minute_entry = ctk.CTkEntry(self.edit_frame, width=50, font=('Arial', 14))
        self.second_entry = ctk.CTkEntry(self.edit_frame, width=50, font=('Arial', 14))
